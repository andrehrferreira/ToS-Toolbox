...
#define LOCTEXT_NAMESPACE "ToSSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* UToSSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UToSSimpleTool* NewTool = NewObject<UToSSimpleTool>(SceneState.ToolManager);
...
void UToSSimpleTool::SetWorld(UWorld* World)
{
	this->TargetWorld = World;
}


void UToSSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<UToSSimpleToolProperties>(this);
	AddToolPropertySource(Properties);
}


void UToSSimpleTool::OnClicked(const FInputDeviceRay& ClickPos)
{
