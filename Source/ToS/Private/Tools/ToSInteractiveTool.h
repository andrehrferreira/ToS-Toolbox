...
#include "ToSInteractiveTool.generated.h"
 ...
 */
UCLASS()
class TOS_API UToSInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class TOS_API UToSInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UToSInteractiveToolProperties();
 ...
 */
UCLASS()
class TOS_API UToSInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UToSInteractiveToolProperties> Properties;
